...
public class PokreniTestove {
	...
	public static void main(String[] args) {
		...
		runTestsForClass(eksponati.fotografije.FotografijaTest.class);
		runTestsForClass(izlozba.IzlozbaTest.class);
		runTestsForClass(ispravka_koda.IspisivacTest.class);
	}
